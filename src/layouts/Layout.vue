  ...
  <div :class="classes">
    ...
    >
      ...
      >
        ...
        <span class="fs-4 title">{{ $t("C8 Digital Server Monitoring") }}</span>
      </router-link>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                <router-link
                  ...
                  class="dropdown-item"
                  :class="{
                    active: $route.path.includes('manage-maintenance'),
                  }"
                >
    ...
    >
      ...
      >
        ...
        <span class="fs-4 title ms-2">C8 Digital Server Monitoring</span>
      </router-link>
    </header>
    ...
    <div
      v-if="$root.isMobile"
      style="width: 100%; height: calc(60px + env(safe-area-inset-bottom))"
    />
